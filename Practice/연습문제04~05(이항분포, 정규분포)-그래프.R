...
geom_bar(data=mtcars[mtcars$name=='Honda Civic', ], aes(x=name, y=mpg), fill='#5CBED2', stat='identity') + geom_text(aes(label=mpg), size=3, hjust=1.25, color='#FFFFFF')
...
# 20년 이하 근무한 종업원 확률을 1에서 빼주면 나머지 20년 이상 근무한 종업원 확률
